...
function Main() {
  return (
    ...
    "
    >
      <p className="text-gray-400 tracking-wider sm:text-xl  lg:relative md:left-96">
      ...
      <div className="lg:flex md:justify-between lg:w-5/6 lg:-mt-16">
        ...
        "
          ...
          data-aos="fade-up"
        >
          <span className="text-2xl text-white font-bold sm:text-5xl lg:text-5xl lg:text-nowrap">
            دنیای NFT های
          </span>
          <span className="text-2xl text-orange-600 font-bold sm:text-6xl lg:text-5xl lg:text-nowrap">
            شگفت انگیز
          </span>
        </h1>
        ...
        <div className="flex justify-center flex-col items-center">
          ...
          />
          <div
            className="backdrop-blur-sm bg-white/5 p-2 flex justify-around items-center rounded-xl w-3/4 absolute bottom-10 my-10
            md:bottom-36
          ...
          >
            ...
            <div className="text-light fw-bold">
              <span className="fs-5 text-white font-bold">+500</span>
              <span className="fs-5 text-white font-bold">هنرمند</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex justify-center items-center flex-col gap-10 lg:w-1/2 lg:absolute mt-20 sm:mt-5 lg:mt-48 lg:right-16 lg:gap-20 ">
        <p
          className="text-gray-500 tracking-wider m-1 sm:text-xl text-center sm:font-bold sm:m-1 sm:-mt-24 lg:hidden xl:block"
          data-aos-duration="500"
          data-aos="fade-up"
        >
