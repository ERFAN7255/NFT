    ...
    >
      ...
      <div className="lg:flex md:justify-between lg:w-5/6 lg:-mt-16">
        ...
        <div class="flex justify-center flex-col items-center">
          <img src="img/header_img.png" class="relative" alt="" />
          <div
            class="backdrop-blur-sm bg-white/5 p-2 flex justify-around items-center rounded-xl w-3/4 absolute bottom-6
            md:bottom-36
      ...
      <div className="flex justify-center items-center flex-col gap-10 lg:w-1/2 lg:absolute mt-20 sm:mt-5 lg:mt-48 lg:right-16 lg:gap-20 ">
        <p class="text-gray-500 tracking-wider m-1 sm:text-xl text-center sm:font-bold sm:m-1 sm:-mt-24">
          لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده
          از طراحان گرافیک است
        </p>
        <div className="lg:flex items-center gap-5">
          <div className="hidden lg:flex border-2 border-red-500 text-white font-bold   rounded-full text-xl items-center p-4 -mt-5">
          ...
          <button className="bg-gradient-to-r from-purple-700 to-orange-700 p-4 rounded-lg text-white font-bold sm:px-20 sm:text-xl sm:-mt-5 lg:rounded-full">
