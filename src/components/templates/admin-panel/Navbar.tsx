...
import { hideNavbar } from "@/Redux/Slices/iShowUserPanelNavbar";
...
function Navbar() {
  ...
  return (
    <>
      ...
      {isShowNavbar && (
        <div
          className={`bg-purple-900  w-3/5 fixed h-screen z-50 top-0 bottom-0`}
          data-aos="fade-left"
        >
      ...
      {/* MD : */}
      <div
        className={`hidden md:block bg-purple-900 w-3/5 md:w-1/3 xl:w-1/5 fixed h-screen`}
        data-aos="fade-left"
      >
        <div className="flex justify-center gap-4 items-center pt-5 lg:gap-6">
          <div>
            <Image src="/img/header_img.png" width={120} height={120} alt="" />
          </div>
